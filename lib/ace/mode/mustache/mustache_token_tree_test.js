...
function loadChange(mustacheTokenTree, text, action) {
    var lines = text.split("\n");
    mustacheTokenTree.change(action, {
        start : {
            row : 0, column : 0
        },
        end : {
...
//    }
    ...
    "test: insert1" : function() {
        var text = "{{#aaa}}{{a}}{{/aaa}}";
        this.doc.setValue(text);
        loadChange(this.mustacheTokenTree, text, "insertText");

        this.doc.setValue("{{#aaa}}{{a}}{{/aaa}}a");
        this.mustacheTokenTree.partialParse({row : 0, column : 21}, {row : 0, column : 22}, "insertText");
        this.mustacheTokenTree.print();
        this.mustacheTokenTree.printList();

        var root = this.mustacheTokenTree.getDocumentElement();
        var list = this.mustacheTokenTree.getAstList();
        assert.equal(root.getChildren().length, 2);
        assert.equal(list.get(0).size() , 4);

        this.doc.setValue("{{#aaa}}{{a}}{{/aaa}}aa");
        this.mustacheTokenTree.partialParse({row : 0, column : 22}, {row : 0, column : 23}, "insertText");
        this.mustacheTokenTree.print();
        this.mustacheTokenTree.printList();

        root = this.mustacheTokenTree.getDocumentElement();
        list = this.mustacheTokenTree.getAstList();
        assert.equal(root.getChildren().length, 2);
        assert.equal(list.get(0).size() , 4);

        this.doc.setValue("{{#aaa}}{{a}}{{/aaa}}aaa");
        this.mustacheTokenTree.partialParse({row : 0, column : 23}, {row : 0, column : 24}, "insertText");
        this.mustacheTokenTree.print();
        this.mustacheTokenTree.printList();
        ...
        this.doc.setValue("{{#aaa}}{{a}}{{/aaa}}aaaa");
        this.mustacheTokenTree.partialParse({row : 0, column : 24}, {row : 0, column : 25}, "insertText");
        this.mustacheTokenTree.print();
        this.mustacheTokenTree.printList();
    ...
    "test: insert2" : function() {
        ...
        var list = this.mustacheTokenTree.getAstList();
        assert.equal(root.getChildren().length, 1);
        assert.equal(list.get(0).size() , 3);

        this.doc.setValue("{{#aaa}}{{aa}}{{/aaa}}");
        this.mustacheTokenTree.partialParse({row : 0, column : 11}, {row : 0, column : 12}, "insertText");
        this.mustacheTokenTree.print();
        this.mustacheTokenTree.printList();

        var root = this.mustacheTokenTree.getDocumentElement();
        var list = this.mustacheTokenTree.getAstList();
        assert.equal(root.getChildren()[0].getChildren().length, 1);
        assert.equal(list.get(0).size() , 3);

        this.doc.setValue("{{#aaa}}{{aaa}}{{/aaa}}");
        this.mustacheTokenTree.partialParse({row : 0, column : 12}, {row : 0, column : 13}, "insertText");
        this.mustacheTokenTree.print();
        this.mustacheTokenTree.printList();
    ...
    "test: insert3" : function() {
        ...
        this.doc.setValue("{{#aaa}}{{a}}{{aaa}}");
        this.mustacheTokenTree.partialParse({row : 0, column : 15}, {row : 0, column : 16}, "removeText");
        this.mustacheTokenTree.print();
        this.mustacheTokenTree.printList();
        ...
        this.doc.setValue("{{#aaa}}{{a}}{{/aaa}}");
        this.mustacheTokenTree.partialParse({row : 0, column : 15}, {row : 0, column : 16}, "insertText");
        this.mustacheTokenTree.print();
        this.mustacheTokenTree.printList();
    ...
    "test: insert4" : function() {
        ...
        this.doc.setValue("{{#aaa}}{{aaaa}}");
        this.mustacheTokenTree.partialParse({row : 0, column : 11}, {row : 0, column : 16}, "removeText");
        this.mustacheTokenTree.print();
        this.mustacheTokenTree.printList();
        ...
        assert.equal(root.getChildren().length, 1);
        assert.equal(root.getChildren()[0].getChildren().length, 1);
        assert.equal(list.get(0).size() , 2);
    ...
    "test: insert5" : function() {
        var text = "{{#aaa}}";
        this.doc.setValue(text);
        loadChange(this.mustacheTokenTree, text, "insertText");

        this.doc.setValue("{{#aaa}}\n");
        this.mustacheTokenTree.partialParse({row : 0, column : 8}, {row : 1, column : 0}, "insertText");
        this.mustacheTokenTree.print();
        this.mustacheTokenTree.printList();
        ...
        var list = this.mustacheTokenTree.getAstList();
        assert.equal(root.getChildren().length, 1);
        assert.equal(list.get(0).size() , 1);

        this.doc.setValue("{{#aaa}}\n{");
        this.mustacheTokenTree.partialParse({row : 1, column : 0}, {row : 1, column : 1}, "insertText");
        this.mustacheTokenTree.print();
        this.mustacheTokenTree.printList();
        ...
        var list = this.mustacheTokenTree.getAstList();
        assert.equal(root.getChildren().length, 1);
        assert.equal(list.get(1).size() , 1);

        this.doc.setValue("{{#aaa}}\n{{");
        this.mustacheTokenTree.partialParse({row : 1, column : 1}, {row : 1, column : 2}, "insertText");
        this.mustacheTokenTree.print();
        this.mustacheTokenTree.printList();
...
debugger;
        this.doc.setValue("{{#aaa}}\n{{/");
        this.mustacheTokenTree.partialParse({row : 1, column : 2}, {row : 1, column : 3}, "insertText");
        this.mustacheTokenTree.print();
        this.mustacheTokenTree.printList();
